...
(function () {
  ...
  var __webpack_modules__ = {
    ...
    function assetsJsMainJs() {
      ...
      function scrollDetect(elem, cls) {
        if (elem.offsetTop - (window.scrollY + window.innerHeight * (4 / 5)) <= 0 && cardfound != true) {
          cardfound = true; // scrollDetect(card1);

          myCards.classList.remove("dnone");
          ...
          card3.classList.remove("animate__slideInRight");
          card3.classList.add("animate__slideInRight");
        }
      }
